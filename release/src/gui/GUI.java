...
public class GUI extends JFrame {
	...
	public GUI(Sewers sewers, int diverRow, int diverCol, long seed, GameState gs) {
		...
		mazePanel.setBounds(PANEL_WIDTH, 0, GAME_WIDTH, GAME_HEIGHT);
		...
		diver.setBounds(PANEL_WIDTH, 0, GAME_WIDTH, GAME_HEIGHT);
		...
		master.add(diver, new Integer(2));
		...
		addComponentListener(new ComponentListener() {
			...
			public void componentResized(ComponentEvent e) {
				...
				mazePanel.setBounds(PANEL_WIDTH, 0, GAME_WIDTH, GAME_HEIGHT); // gries changed from
																			  // 0
				diver.setBounds(PANEL_WIDTH, 0, GAME_WIDTH, GAME_HEIGHT);  // gries changed from 0
				diver.repaint();
	...
	public void updateTimeLeft(int stepsLeft) {
		options.updateStepsLeft(stepsLeft);
	}

	/** What is the specification? */
	public void updateSewer(Sewers c, int numStepsRemaining) {
	...
	/** The main program. Run get-ring and flee on a random seed, <br>
